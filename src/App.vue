	...
	<div class="font-sans" :class="{'bg-gray-900': answeredOrSkipped}">
		...
		<div v-if="!finished" class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			...
			<div class="mx-auto py-8 sm:py-4 lg:py-12 flex items-center space-x-3 text-sky-500">
				<svg class="h-12 w-12 text-sky-100" aria-hidden="true" focusable="false" data-prefix="fal"
				...
				<span class="font-logo text-5xl" :class="{'text-sky-50': answeredOrSkipped}">Well Dave<span class="font-sans font-thin">&hellip;</span></span>
