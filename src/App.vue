...
<template>
	<div class="font-sans" :class="{'bg-sky-900 bg-gradient-to-t via-indigo-900 from-black': answeredOrSkipped}">
		...
		<div v-if="!finished" class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			...
			<div class="mx-auto py-8 sm:py-4 lg:py-12 flex items-center space-x-3 text-sky-500">
				...
				<span class="font-logo text-2xl md:text-5xl" :class="{'text-sky-50': answeredOrSkipped}">Well Dave<span class="font-sans font-thin">&hellip;</span></span>
